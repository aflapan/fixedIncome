...
class Bond(object):
    ...
    #---------------------------------------------------------------------------
    #
    def calculate_payment_accrual_factors(self, purchase_date: datetime.date = None) -> pd.Series:
        """
    ...
    def calculate_continuously_compounded_yield_to_maturity(self, purchase_date: datetime.date = None,
